...
<html>
    ...
    <body>
        ...
        if (isset($_POST['enviar'])) {
            ...
            $sql = "select id, idDireccion, nombre from autoridades where email='$correo'";
            ...
            $nombreDireccion = $nombreUnidad[0];
            ...
            if ($eje) {
                ...
                mail($destino, "Plataforma Planes de Trabajo - Direccion de $nombreDireccion - Ingreso Plan de Trabajo", $contenido);
                $text = 'true';
                echo "<script>"
                . "alerta($text);"
                . "</script> <script> location.href='https://www.d.pcspucv.cl/planes/proyecto_planesTrabajo/formulario_planes/primera_parte_direc.php?correo=" . $correo . "'</script>;";
            } else {
