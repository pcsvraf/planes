...
if (isset($_POST['enviar'])) {
    ...
    $sqlo = "select id, idUnidad, nombre from autoridades where email='$correo'";
    ...
    if ($ejecutar) {
        ...
        header('Location: https://www.d.pcspucv.cl/planes/proyecto_planesTrabajo/vistas/accionEnPlanesJ.php?correo='.$correo);
    } else {
