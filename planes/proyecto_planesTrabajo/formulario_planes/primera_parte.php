...
<html>
    ...
    <body class="contenedor">
        <br>
        <div class="container">
            <form action="../funciones/enviarDatos.php" id="formulario" method="POST">
                ...
                <div class="row">
                    <center><div class="col-md-2 col-md-offset-2">
                            <?php echo '<a href="../vistas/menu.php?correo=' . $correo . '"><input type="button" value="Volver" class="btn btn-primary offset-sm-3"></a>'; ?>
                        </div></center>
...
<!--                  <label class="radio-inline">
                        <input required="" type="radio" name="radios" class="radios" id="radios" value="Calidad de Servicio">Calidad de Servicio
                    </label> 
                    <label class="radio-inline">
                        <input required="" type="radio" name="radios" class="radios" id="radios" value="Eficiencia Operacional">Eficiencia Operacional
                    </label>
                    <label class="radio-inline">
                        <input required="" type="radio" name="radios" class="radios" id="radios" value="Mejoramiento Funcional/Proceso">Mejoramiento Funcional/Proceso
                    </label>-->