...
$query1 = "select idUnidad, nombre from autoridades where email ='$correo' ";
...
<html>
    ...
    <body style="color: #12548c;">
        ...
        <div id="container-main">
            <div class="accordion-container">
                <div class="offset-sm-11">
                    <a href="../vistas/listar_pdf.php?id=<?php echo $idSoli; ?> " class ="btn" style="color:#fff; background-color: #12548c">lista</a>
                </div>
                <br>
        ...
        <?php echo'<a href="../vistas/lista_planes.php?correo=' . $datos['email'] . '"><button class="btn btn-primary offset-2" style="background-color: #12548c; border: #12548c;">Volver   
            </button></a>' ?>
        <br>
...
if (isset($_POST['enviar1'])) {
    ...
    if ($nombre != "") {
        if (move_uploaded_file($ruta, $destino)) {
            ...
            mail($destino, "Plataforma Planes de Trabajo - Unidad $unidad - Carga de Medio de Verificación", $contenido);
        } else {
            echo "Error";
        }
    }
