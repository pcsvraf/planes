...
<html>  
                    ...
                    while ($row = $connect->fetch_row($result)) {
                        ...
                        <tr>  
                            ...
                            <?php if ($row["estado"] == 'Ingresado') { ?>
                                ...
                                <td><?php echo '<button type="button" value="' . $row['id'] . '" onClick="confirmarEliminacion(' . $row['id'] . ');" class="btn btn-danger eliminar">Eliminar</button>'; ?></td>
                        ...
                        <?php } else if ($row["estado"] == 'Enviado') { ?>
                            ...
                            <td><?php echo '<button type="button" value="' . $row['id'] . '" disabled="" onClick="confirmarEliminacion(' . $row['id'] . ');" class="btn btn-danger eliminar">Eliminar</button>'; ?></td>
    ...
    <script>
        ...
        $(document).on('click', '.plan', function () {
            var id = $(this).val();
            var correo = '<?php echo $correo ?>';
            window.location = 'vistaPlanesJ.php?id=' + id + '&correo=' + correo;
        });
