...
$query = "SELECT * FROM planes WHERE email = '$correo' && estado != 'Ingresado'  ORDER BY id DESC";
        ...
        <div class="container">  
            ...
            <div class="table-responsive">  
                <table id="tablaPlanes" class="table table-striped">  
                    ...
                    <td class="tituloTabla">Observacion</td>
                    </tr>  
                    </thead>  
                    <?php
                    while ($row = $db->fetch_row($ejecuta)) {
                        ...
                        <tr>  
                            ...
                            <?php } else if ($row['estado'] == 'Revisado por PCS') { ?>
                                <td><button type="button" disabled="" class="btn btn-info">Aceptar</button></td>
                                <td><button type="button" disabled="" class="btn btn-danger">Rechazar</button></td>
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <form action="../funcionesAdmin/rechazar.php" method="POST">
            ...
            <div class="modal fade" id="myModal2" role="dialog">
                <form action="../funcionesAdmin/aceptar.php" method="POST">
                    <div class="modal-dialog">
                        <!-- Modal content-->
                        <div class="modal-content">
                            <div class="modal-header">
...
<script>
    ...
    $(document).on('click', '.plan', function () {
        ...
        window.location = 'planIndividual.php?id=' + id + '&correo=' + correo;
    });
